...
ac_page = TOOL_LABEL + """<h1>Ask the Guide</h1>
<p class="lede">Ask a question about anything in this guide &mdash; essay structure, quotes, techniques, the assessors&rsquo; advice &mdash; and get an answer drawn from the site&rsquo;s own pages, with links to read more.</p>
<div id="ac-log" class="ac-log"></div>
<div class="tool-bar" style="align-items:stretch">
  <input id="ac-q" type="text" placeholder="e.g. How should I structure a Section C introduction?" style="flex:1;padding:12px 16px;border:1px solid var(--line);border-radius:10px;background:var(--card);color:var(--ink);font-family:var(--serif);font-size:16px">
  <button id="ac-send">Ask</button>
</div>
<p style="font-family:var(--sans);font-size:12.5px;color:var(--muted)">Answers are generated by AI from this site&rsquo;s content and can still make mistakes &mdash; check the linked pages, and ask your teacher when it matters. Shared class service: please keep questions study-related.</p>
...
(function(){
  ...
  function ask(){
    ...
    .then(function(res){
      ...
      var prompt = "You are 'Ask the Guide', a study assistant for a VCE English exam preparation " +
...
<div class="ch-list">
  ...
  <a class="ch-card" href="ask-the-guide.html"><span class="ch-num">10</span><span>Ask the Guide</span></a>
</div>
...
nav_items.append({"num": tools_num, "title": "Study Tools", "file": "study-tools.html",
                  "chapters": [{"title": "Quote Flashcards", "file": "flashcards.html"},
                               ...
                               {"title": "Ask the Guide", "file": "ask-the-guide.html"}]})
...
all_pages.append({"file": "ask-the-guide.html", "title": "Ask the Guide", "html": ac_page, "nav": "study-tools.html"})
...
<script src="assets/site.js?v=36"></script>
