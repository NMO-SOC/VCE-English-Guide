...
<p class="lede">A sixteen-stage scavenger hunt through this guide. Every answer is buried in these pages — in the scenes, the quote banks, the glossary, the exemplars. No answer is typed anywhere in this page’s code, so there is only one way through: read like a top-scoring student. Progress saves on this device. Finish, and bring what you find to Mr Morlin.</p>
...
(function(){
  ...
  function finish(){
    ...
    card.innerHTML = '<div class="hunt-done"><div class="hunt-code">' + out + '</div>' +
      '<p>All sixteen locks opened. You have crossed both texts, walked a personal journey and named the machinery of persuasion \u2014 that is a revision session most students never do. Show the words above to Mr Morlin.</p></div>';
