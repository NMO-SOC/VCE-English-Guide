...
<script>window.AC_INDEX_URL = 'assets/search.json'; window.AC_EMB_URL = 'assets/embeddings.json'; window.AC_WORKER = 'https://jolly-waterfall-d01a.nicholas-morlin.workers.dev/';</script>
<script>
(function(){
